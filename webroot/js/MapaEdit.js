//Asignar mapa a la division mapa
	var mymap = L.map('mapid').setView([$("#latitude").val(), $("#length").val()], 18);
	...
	var marker2 = L.marker([$("#latitude").val(), $("#length").val()],{icon: iconMarker}).addTo(mymap);
